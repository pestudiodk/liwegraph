...
await Promise.all([
  ...
  build({ entryPoints: [new URL("../src/layout-materialisation/elk-layout-materialiser.ts", import.meta.url).pathname], bundle: true, format: "esm", platform: "node", target: "node20", outfile: new URL("../build/layout-materialisation/elk-layout-materialiser.js", import.meta.url).pathname }),
