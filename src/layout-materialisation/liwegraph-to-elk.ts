...
export function createElkGraph(parsed: LiweGraph, routing: LiweGraphRouting, existingNodes: Map<string, LiweGraphLayoutNode>): LiweGraphElkModel {
  ...
  const graph: ElkNode = { id: "root", children, edges, layoutOptions: { "elk.algorithm": "layered", "elk.direction": "DOWN", "elk.edgeRouting": routing === "direct" ? "POLYLINE" : "ORTHOGONAL", "elk.hierarchyHandling": "INCLUDE_CHILDREN", "elk.padding": elkPadding(), "elk.spacing.nodeNode": "48", "elk.layered.spacing.nodeNodeBetweenLayers": "72", "elk.spacing.edgeNode": "24", "elk.spacing.edgeEdge": "14", "elk.spacing.edgeLabel": "14", "elk.spacing.labelLabel": "20", "elk.spacing.labelNode": "20", "elk.edgeLabels.placement": "CENTER", "elk.edgeLabels.inline": "false", "elk.layered.edgeLabels.sideSelection": "SMART_DOWN", "elk.aspectRatio": "1.35", "elk.separateConnectedComponents": "true", "elk.componentCompaction.componentLayoutAlgorithm": "org.eclipse.elk.box" } };
